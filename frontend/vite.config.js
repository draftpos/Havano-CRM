...
export default defineConfig(async ({ mode }) => {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          display: 'standalone',
          name: 'Havano CRM',
          short_name: 'Havano CRM',
          start_url: '/havano-crm',
          description:
            'Modern & 100% Open-source CRM tool to supercharge your sales operations',
          icons: [
            {
              src: '/assets/havano_crm/manifest/manifest-icon-192.maskable.png',
              sizes: '192x192',
              type: 'image/png',
              purpose: 'any',
            },
            ...
            {
              src: '/assets/havano_crm/manifest/manifest-icon-512.maskable.png',
              sizes: '512x512',
              type: 'image/png',
              purpose: 'any',
            },
  ...
  config.plugins.unshift(
    frappeui({
      ...
      jinjaBootData: true,
      buildConfig: {
        indexHtmlPath: '../havano_crm/www/havano_crm.html',
        emptyOutDir: true,
        sourcemap: true,
      },
    }),
