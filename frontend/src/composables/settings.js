...
createResource({
  url: 'havano_crm.api.whatsapp.is_whatsapp_enabled',
...
createResource({
  url: 'havano_crm.api.whatsapp.is_whatsapp_installed',
...
createResource({
  url: 'havano_crm.integrations.api.is_call_integration_enabled',
