<template>
  <div class="h-full w-full">
    <div
      ...
      class="flex h-full w-full cursor-pointer overflow-hidden rounded bg-white shadow"
    >
    ...
    <div
      ...
      class="h-full w-full rounded-md bg-white shadow"
    >
      <AxisChart v-if="item.data" :config="item.data" />
    </div>
    <div
      v-else-if="item.type == 'donut_chart'"
      class="h-full w-full rounded-md bg-white shadow overflow-hidden"
    >
