<template>
  <div class="flex items-center">
    ...
    >
      {{ breadcrumbLabel ? __(breadcrumbLabel) : __(routeName) }}
    </router-link>
    <span
...
defineProps({
  ...
  /** When set, shown in the breadcrumb instead of translating `routeName` (e.g. route stays `Tasks`, label shows `Todo`). */
