  ...
  <Dropdown :options="dropdownItems" v-bind="$attrs">
    <template #default="{ open }">
      <button
        ...
        :class="
          isCollapsed
            ...
            : nexusSidebar
              ? open
                ? 'w-full px-2 bg-white/10 shadow-none'
      ...
      >
        ...
        >
          <div
            class="truncate text-base font-medium leading-none"
            :class="nexusSidebar ? 'text-white' : 'text-ink-gray-9'"
          >
            {{ __(brand.name || 'CRM') }}
          </div>
          <div
            class="mt-1 truncate text-sm leading-none"
            :class="nexusSidebar ? 'text-slate-300' : 'text-ink-gray-7'"
          >
            {{ user.full_name }}
          </div>
        </div>
        ...
        >
          <FeatherIcon
            name="chevron-down"
            class="size-4"
            :class="nexusSidebar ? 'text-slate-300' : 'text-ink-gray-5'"
            aria-hidden="true"
          />
        </div>
      </button>
...
const nexusSidebar = inject('nexusSidebar', false)
