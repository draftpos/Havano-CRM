...
function getParams() {
  ...
  let order_by = _view?.order_by || 'modified desc'
  if (
    props.doctype === 'ToDo' &&
    view_type === 'list' &&
    !_view?.order_by
...
list.value = createResource({
  url: 'havano_crm.api.doc.get_data',
  params: getParams(),
...
const updateQuickFilters = createResource({
  url: 'havano_crm.api.doc.update_quick_filters',
  onSuccess() {
...
const quickFilters = createResource({
  url: 'havano_crm.api.doc.get_quick_filters',
